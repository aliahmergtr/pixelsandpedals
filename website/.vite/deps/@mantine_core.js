  ...
  "node_modules/react/cjs/react-jsx-runtime.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        function jsxDEV(type, config, maybeKey, source, self) {
          {
            ...
            if (type && type.defaultProps) {
              var defaultProps181 = type.defaultProps;
              for (propName in defaultProps181) {
                if (props[propName] === void 0) {
                  props[propName] = defaultProps181[propName];
                }
              }
            }
            if (key || ref) {
        ...
        var jsx253 = jsxWithValidationDynamic;
...
var useReactId2 = React11["useId".toString()];
...
var Avatar = polymorphicFactory((_props, ref) => {
  ...
  const [error, setError] = (0, import_react238.useState)(!src);
  const getStyles2 = useStyles({
    name: "Avatar",
    props,
    classes: classes27,
...
var Image = polymorphicFactory((_props, ref) => {
  ...
  const [error, setError] = (0, import_react295.useState)(!src);
...
function NumberFormatBase(props) {
  ...
  var useIsomorphicLayoutEffect = typeof window !== "undefined" ? import_react335.useLayoutEffect : import_react335.useEffect;
...
var RingProgress = factory((_props, ref) => {
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset2 }, index5) => (0, import_react372.createElement)(
    Curve,
    {
      ...data,
      key: index5,
